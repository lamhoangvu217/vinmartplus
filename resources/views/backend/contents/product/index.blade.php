                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li class="nk-block-tools-opt">
                                            ...
                                            <a href="{{ route('product.create')}}" class="btn btn-primary d-none d-md-inline-flex"><i class="fas fa-plus"></i><span>Add Product</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col nk-tb-col-tools">
                                <ul class="nk-tb-actions gx-1 my-n1">
                                    <li class="mr-n1">
                                        <div class="dropdown">
                                            <a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown"><i class="fas fa-ellipsis-v"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                        ...
                        @foreach ($products as $product)
                            ...
                            <div class="nk-tb-col tb-col-sm">
                                <span class="tb-product">
                                    ...
                                    <a target="_blank" href="{{route('detail', $product->id)}}" class="title">{{ $product->name }}</a>
                                </span>
                            </div>
                            ...
                            <div class="nk-tb-col nk-tb-col-tools">
                                <ul class="nk-tb-actions gx-1 my-n1">
                                    <li class="mr-n1">
                                        <div class="dropdown">
                                            <a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown"><i class="fas fa-sort-down"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    <li><a href="{{route('product.edit', $product->id)}}"><span>Sửa sản phẩm</span></a></li>
                                                   
                                                    <li><a href="{{ route('product.delete', $product->id) }}"><span>Xóa sản phẩm</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
